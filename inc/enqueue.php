...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script( 'jsbar', 'https://cdnjs.cloudflare.com/ajax/libs/jsbarcode/3.11.5/JsBarcode.all.min.js', array(), $js_version, true );		
		wp_enqueue_script( 'heas-scripts', get_template_directory_uri() . '/js/heas.js', array('jsbar'), $js_version, true );
